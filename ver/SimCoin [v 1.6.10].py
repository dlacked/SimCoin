...
os.system("mode con cols=80 lines=1000")
os.system("cls")
...
if (MyMoney-10000000)/100000 < 0:
    print("(기존 금액보다 " + '%.2f' % float((MyMoney-10000000)/-100000) + "% 감소)")
else:
    print("(기존 금액보다 " + '%.2f' % float((MyMoney-10000000)/100000) + "% 증가)")
