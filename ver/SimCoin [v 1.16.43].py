...
print("    └  Changmo.ney (ICY) 화폐는 일정 확률로 " + text.DarkCyan + "투자한 금액의 100000%" + text.End + "를 돌려줍니다.\n")
print("    └  Specoin (SPC) 화폐는 시세 하락의 확률이 [일반 코인]보다 2배가 높지만,")
print("       상승 시 " + text.DarkCyan + "최대 1000%까지 상승" + text.End + "할 수 있습니다.")
print("\n\n[입력법]\n")
print("● 가상 화폐를 " + text.DarkCyan + "구매/판매" + text.End + "하고 싶다면, 수량과 통화를")
print("   다음과 같은 형식으로 입력하십시오.")
print(text.Green + "   [수량] [통화]" + text.End)
print("   ex) 12 ICY\n")
print("    └  " + text.Green + "[수량]에 0 입력" + text.End + " 시, [통화]에 해당하는 화폐를 구매/판매할 수 있는")
print("       " + text.DarkCyan + "최대한으로 구매/판매" + text.End + "할 수 있습니다.")
print("       ex) 0 BTC\n")
print("    └  대소문자는 따로 구분하지 않습니다.")
print("       하지만, 대소문자를 섞어 입력하면 인식하지 못하므로\n       통일하여 입력해주시기 바랍니다.\n")
print("● " + text.DarkCyan + "취소" + text.End + "하고 싶다면 다음 명령어를 입력하십시오.")
print(text.Green + "   0 /esc\n" + text.End)
print("● 명령어에 대한 " + text.DarkCyan + "도움이 필요" + text.End + "하다면 다음 명령어를 입력하십시오.")
...
print("본문을 다 읽으셨다면, 아무 키를 눌러 실행하십시오.")
os.system("pause >nul")
...
for i in range(0, 11):
    ...
    while (True):
        ...
        if Num == "1":
            if i == 10:
                print(text.Green + "\n[System]>> 마지막 턴에서는 구매하실 수 없습니다." + text.End)
            else:
                while (True):
                    ...
                    if Initial == "DASH" or Initial == "dash": 
                        ...
                        print("\n구매 : " + text.Green + "[수량] [화폐 이니셜]" + text.End)
                        print("ex)1 ICY")
                        print("최대 구매 : " + text.Green + "0 [화폐 이니셜]" + text.End)
                        print("ex)0 BTC")
        ...
        #판매
            ...
            if i == 0:
                print(text.Green + "\n[System]>> 0턴에서는 구매하실 수 없습니다." + text.End)
            else:
                while (True):
                    Amount, Initial = input("\n명령어를 입력하십시오.\n>>> ").split()
                    ...
                    if Initial == "DASH" or Initial == "dash":
                        ...
                        print("\n판매 : " + text.Green + "[수량] [화폐 이니셜]" + text.End)
                        print("ex)1 ICY")
                        print("최대 판매 : " + text.Green + "0 [화폐 이니셜]" + text.End)
                        print("ex)0 BTC")
                        print("취소 : " + text.Green + "0 /esc" + text.End)
                        print("도움 : " + text.Green + "0 /helpme" + text.End)
                        break
